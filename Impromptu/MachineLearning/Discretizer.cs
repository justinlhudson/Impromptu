...
{
    private double[] data;
    // sorted copy of distinct raw numeric data
    private int k;
    // number of clusters = number of categories. must be > data.Length
    private double[] means;
    // average of pts in each cluster, from sums[] and counts[]
    private int[] clustering;
    // index = index into data[], value = cluster ID
